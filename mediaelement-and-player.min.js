...
(function ($) {
	...
	mejs.MepDefaults = {
		...
		keyActions: [
				...
				//Bobby: 11Nov2015: disabling global hook for up/down arrows for volume as it conflicts with subtitle selection
				/*{
						keys: [38], // UP
						action: function(player, media) {
	...
	$.extend(MediaElementPlayer.prototype, {
		buildstop: function(player, controls, layers, media) {
			...
			$('<div class="mejs-button mejs-stop-button mejs-stop">' +
					'<button type="button" aria-controls="' 
						+ t.id 
						+ '" title="' + t.options.stopText 
						+ '" aria-label="' + t.options.stopText 
					+ '">'+t.options.stopText+'</button>' +
				'</div>')
				.appendTo(controls)
				.click(function() {
					if (!media.paused) {
...
(function($) {
	...
	$.extend(mejs.MepDefaults, {
		...
		//Bobby: 12Nov2015, changing to horizontal due to shift-tab focus issues
		...
		buildvolume: function(player, controls, layers, media) {
			...
			var t = this,
				...
				$('<div class="mejs-button mejs-volume-button mejs-mute">' +
					...
					'">'+t.options.muteText+'</button>'+
				'</div>' +
                  '<a href="javascript:void(0);"' + 						
						' title="' + t.options.allyVolumeControlText + 
						'" aria-label="' + t.options.allyVolumeControlText + 
						'" class="mejs-horizontal-volume-slider">' + // outer background
            ...
            var updateVolumeSlider = function (e) {
				...
				volumeSlider.attr({
					//Bobby: 12Nov2015, aria-label is already set
			...
			var t = this,
				fullscreenBtn =
					$('<div class="mejs-button mejs-fullscreen-button">' +
						'<button type="button" aria-controls="' 
							+ t.id 
							+ '" title="' + t.options.fullscreenText 
							+ '" aria-label="' + t.options.fullscreenText 
						+ '">'+t.options.fullscreenText+'</button>' +
					'</div>')
					.appendTo(controls);
...
(function($) {
	...
	$.extend(mejs.MepDefaults, {
		...
		//Bobby: 12Nov2015, substitle selector has issues with keyboard navigation, so use basic toggle for caption on/off
		...
		buildtracks: function(player, controls, layers, media) {
			...
			player.captionsButton =
					$('<div class="mejs-button mejs-captions-button">'+
							'<button type="button" aria-controls="' + t.id 
								+ '" title="' + t.options.tracksText 
								+ '" aria-label="' + t.options.tracksText 
							+ '">'+t.options.tracksText+'</button>'+
